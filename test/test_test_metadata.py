...
def test_read(test_data_dir, helpers):
    ...
    assert test_instance.runsOn == JENKINS
    assert test_instance.service == JENKINS
    ...
    assert test_definition.conformsTo == PLANEMO
    assert test_definition.engine == PLANEMO
...
def test_create():
    ...
    test_instance.runsOn = {"@id": JENKINS}
    ...
    test_definition.conformsTo = {"@id": PLANEMO}
